...
export const BentoGridItem = ({
  ...
  const leftLists = ["ReactJS", "ReactJS", "NodeJS"];
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("kapil95550@gmail.com").then(() => {
      setCopied(true);
  ...
  return (
    ...
    >
      <div className={`${id === 6 ? "flex justify-center" : ""} h-full relative`}>
        ...
        {/* Spare Image (e.g., bottom decoration) */}
        {spareImg && (
          <div
        ...
        >
          ...
          {/* Copy Button and Lottie Animation */}
          {id === 6 && (
